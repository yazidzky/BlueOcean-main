...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 rounded-xl shadow-md hover:shadow-lg hover:-translate-y-0.5",
        destructive:
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary-variant rounded-full shadow-glow hover:scale-105 font-semibold",
        glass:
          "glass-card text-foreground hover:bg-accent/50 rounded-xl backdrop-blur-md border border-border/50",
        success:
          "bg-success text-success-foreground hover:bg-success/90 rounded-xl shadow-md",
      },
      size: {
